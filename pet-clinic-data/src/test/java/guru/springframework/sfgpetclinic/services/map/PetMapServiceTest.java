...
class PetMapServiceTest {
    ...
    void setUp() {
        ...
        petMapService.save(PetBuilder.builder().setId(petId).build());
    }
    ...
    void saveExistingId() {
        ...
        Pet pet2 = PetBuilder.builder().setId(id).build();
    ...
    void saveNoId() {
        ...
        Pet savedPet = petMapService.save(PetBuilder.builder().build());
    ...
    void deleteWithWrongId() {
        ...
        Pet pet = PetBuilder.builder().setId(5L).build();
    ...
    void deleteWithNullId() {
        ...
        Pet pet = PetBuilder.builder().build();
